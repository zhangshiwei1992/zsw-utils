...
public class LocalExcelUtils {
    ...
    private static Logger                              log                = LoggerFactory
            .getLogger(LocalExcelUtils.class);
        ...
        if (cell != null) {
            ...
            switch (cellType) {
                case NUMERIC:
                    ...
                    break;
                case STRING:
                    if (cell.getStringCellValue().trim().length() >= DATE_LENGTH && verificationDate(
                            cell.getStringCellValue(), LocalExcelUtils.initialization().dateFormatStr)) {
                        val = strToDateFormat(cell.getStringCellValue(), LocalExcelUtils.initialization().dateFormatStr,
                                LocalExcelUtils.initialization().expectDateFormatStr);
                    } else {
